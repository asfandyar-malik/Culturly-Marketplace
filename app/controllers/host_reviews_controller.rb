class HostReviewsController < ApplicationController
  ...
  private
    def host_review_params
      params.require(:host_review).permit(:comment, :star, :event_id, :reservation_id, :guest_id)
    end
end
