class GuestReviewsController < ApplicationController
    ...
    def create
        # Step 1: Check if the reservation exist (event_id, host_id, host_id)
        ...
        @reservation = Reservation.where(
            ...
            event_id: guest_review_params[:event_id]
        ).first
        
        if !@reservation.nil? && @reservation.event.user.id == guest_review_params[:host_id].to_i
    ...
    def guest_review_params
        params.require(:guest_review).permit(:comment, :star, :event_id, :reservation_id, :host_id)
    end
end
